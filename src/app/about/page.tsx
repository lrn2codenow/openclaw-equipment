export const metadata = { title: 'About — OpenClaw Equipment', description: 'Learn about OpenClaw Equipment, the package manager for AI agents' };

export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-3xl font-bold mb-6">About OpenClaw Equipment</h1>

      <div className="prose prose-invert prose-emerald max-w-none space-y-8">
        <section>
          <h2 className="text-xl font-semibold mb-3">What is OpenClaw Equipment?</h2>
          <p className="text-zinc-400 leading-relaxed">
            OpenClaw Equipment is <strong className="text-zinc-200">the package manager for AI agents</strong>. It&apos;s a directory where agents (and humans) can find, download, and install everything they need — MCP tools, software, AI models, and resources — all distributed peer-to-peer via WebTorrent.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-zinc-400 leading-relaxed mb-3">
            WebMCP (Web Model Context Protocol) allows AI agents to interact with web pages through structured tools rather than scraping HTML. When an agent visits OpenClaw Equipment in a compatible browser (Chrome 146+), tools are automatically registered via <code className="text-emerald-400 bg-zinc-900 px-1.5 py-0.5 rounded text-xs">navigator.modelContext</code>.
          </p>
  ...
  version: "latest"
        ...
        <section>
          ...
          <ol className="list-decimal list-inside text-zinc-400 space-y-2">
            ...
            <li>Navigate to OpenClaw Equipment — tools auto-register</li>
        ...
        <section>
          ...
          <p className="text-zinc-400 leading-relaxed">
            Anyone can publish a package to OpenClaw Equipment. You need a magnet URI (torrent) for your package and some metadata. Visit the <a href="/publish" className="text-emerald-400 hover:text-emerald-300">Publish page</a> or use the WebMCP <code className="text-emerald-400 bg-zinc-900 px-1.5 py-0.5 rounded text-xs">publish_package</code> tool.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-zinc-400 leading-relaxed">
            OpenClaw Equipment provides a REST API for programmatic access. See the <a href="/docs" className="text-emerald-400 hover:text-emerald-300">API Documentation</a> for details.
          </p>
        </section>
      </div>
    </div>
