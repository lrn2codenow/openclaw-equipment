...
export const clinicalTheme: AgentTheme = {
  accent: 'teal',
  secondary: 'emerald',
  gradient: 'from-teal-500 via-emerald-500 to-cyan-400',
  glowBg: 'bg-teal-500/5',
  cardHoverBorder: 'hover:border-teal-500/30',
  cardGlowFrom: 'from-teal-500/5',
  cardGlowTo: 'to-emerald-500/5',
  toolDot: 'text-teal-500',
  loadoutBg: 'bg-teal-500/10',
  loadoutBorder: 'border-teal-500/20',
  loadoutText: 'text-teal-400',
  powerLevelText: 'text-teal-400',
};
...
export const profiles: AgentProfile[] = [
  ...
  {
    slug: 'behavior-assessment-writer',
    name: 'Assessment Writer',
    title: 'Behavior Assessment & Treatment Planning Specialist',
    emoji: '📋',
    description: 'Takes an autism diagnosis and builds a complete behavior assessment — from intake to goals. Runs the entire pipeline: diagnosis parsing, interview generation, questionnaire management, observation planning, and measurable goal writing.',
    longDescription: "The most time-consuming part of a BCBA's job is the initial assessment — easily 10-20 hours per client. This agent handles 80% of that pipeline autonomously. Give it a diagnostic report and it identifies every symptom, impairment, and area of concern. It generates tailored parent interview questions, builds custom questionnaires, processes the responses, recommends specific standardized assessments and observation protocols, analyzes observation data, and drafts measurable goals and objectives aligned to the treatment plan. The BCBA reviews, approves, and signs — but the heavy lifting is done. Think of it as a clinical co-pilot that turns a 15-hour assessment into a 3-hour review.",
    autonomyLevel: 'assistant',
    autonomyLabel: 'Assistant (BCBA reviews and approves all outputs)',
    autonomyColor: 'yellow',
    autonomyEmoji: '🟡',
    securityLevel: '🔴 HIPAA — all data local, no cloud transmission of PHI, BAA-compliant infrastructure only',
    securityEmoji: '🔴',
    platform: 'Local deployment (HIPAA requirement)',
    platformStatus: 'active',
    loadout: {
      name: 'Behavior Assessment Writer',
      slug: 'behavior-assessment-writer',
      tools: [
        'Diagnosis Parser (DSM-5-TR / ICD-10)',
        'Interview Question Generator',
        'Questionnaire Builder & Scorer',
        'Parent/Caregiver Interview Processor',
        'Assessment Recommender (VB-MAPP, ABLLS-R, AFLS, Vineland, etc.)',
        'Observation Protocol Designer',
        'Observation Data Analyzer',
        'Goal & Objective Writer (SMART format)',
        'Treatment Plan Drafter',
        'Insurance Authorization Formatter',
        'Document Templates (clinic-customizable)',
        'Progress Report Generator',
      ],
    },
    abilities: [
      { name: 'Diagnosis Parsing', level: 9, manaCost: 15, category: 'core' },
      { name: 'Interview Generation', level: 9, manaCost: 12, category: 'core' },
      { name: 'Questionnaire Management', level: 8, manaCost: 10, category: 'core' },
      { name: 'Assessment Selection', level: 9, manaCost: 18, category: 'core' },
      { name: 'Observation Planning', level: 8, manaCost: 14, category: 'core' },
      { name: 'Goal Writing (SMART)', level: 10, manaCost: 20, category: 'core' },
      { name: 'Treatment Plan Drafting', level: 9, manaCost: 25, category: 'specialist' },
      { name: 'Insurance Auth Formatting', level: 8, manaCost: 12, category: 'specialist' },
      { name: 'Parent Communication', level: 8, manaCost: 8, category: 'utility' },
      { name: 'Data Interpretation', level: 9, manaCost: 16, category: 'specialist' },
      { name: 'Progress Monitoring', level: 8, manaCost: 10, category: 'utility' },
    ],
    stats: [
      { label: 'Time Saved', value: '~12 hrs/client' },
      { label: 'Assessment Types', value: 'VB-MAPP, ABLLS-R, AFLS, Vineland, CARS-2' },
      { label: 'Goal Format', value: 'SMART + BACB aligned' },
      { label: 'HIPAA', value: 'Required — local only' },
      { label: 'Output', value: 'Full treatment plan draft' },
      { label: 'Model', value: 'Claude Opus 4 (recommended)' },
    ],
    activeSince: '2026-03-03',
    status: 'online',
    statusMessage: 'Ready for intake',
    theme: clinicalTheme,
  },
];
